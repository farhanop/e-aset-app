...
export function UnitKerjaForm({ initialData, onSave, onCancel }: FormProps) {
  ...
  const validateForm = () => {
    ...
    } else if (formData.kode_unit.length > 20) {
      newErrors.kode_unit = "Kode unit maksimal 20 karakter";
    }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        <label htmlFor="id_unit_utama" className={`block text-sm font-medium ${
      ...
      <div>
        <label htmlFor="kode_unit" className={`block text-sm font-medium ${
          theme === "dark" ? "text-gray-300" : "text-gray-700"
        }`}>
      ...
      <div>
        <label htmlFor="nama_unit" className={`block text-sm font-medium ${
          theme === "dark" ? "text-gray-300" : "text-gray-700"
        }`}>
        ...
        <div className="mt-1">
          <input
            ...
            placeholder="Masukkan nama prodi/unit kerja"
          />
        </div>
        {errors.nama_unit && (
          <p className={`mt-1 text-sm ${
