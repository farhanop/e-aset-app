    ...
    <div className={`p-6 rounded-lg shadow-md ${
        ...
        <div>
          ...
          <div className="space-y-3">
            <div>
              ...
              <div className={`mt-1 block w-full rounded-md ${
                theme === "dark" ? "bg-gray-700 text-white" : "bg-gray-50 text-gray-900"
              } p-2 border ${theme === "dark" ? "border-gray-600" : "border-gray-300"}`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="space-y-3">
            <div>
              ...
              <div className={`mt-1 block w-full rounded-md ${
                ...
                {asset.tanggal_perolehan ? new Date(asset.tanggal_perolehan).toLocaleDateString('id-ID') : 'N/A'}
              </div>
            </div>
        ...
        <div>
          ...
          <div className={`mt-1 block w-full rounded-md ${
            theme === "dark" ? "bg-gray-700 text-white" : "bg-gray-50 text-gray-900"
          } p-2 border ${theme === "dark" ? "border-gray-600" : "border-gray-300"} min-h-[100px]`}>
            {asset.keterangan || '-'}
          </div>
        </div>
      </div>
